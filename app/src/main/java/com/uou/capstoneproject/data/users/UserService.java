package com.uou.capstoneproject.data.users;

import com.uou.capstoneproject.data.NetworkModule;
import com.uou.capstoneproject.data.users.response.info.GetSimpleInfoResponse;
import com.uou.capstoneproject.data.users.response.info.GetUserInfoResponse;
import com.uou.capstoneproject.data.users.response.push.GetPushListResponse;
import com.uou.capstoneproject.data.users.response.record.GetRecordResponse;
import com.uou.capstoneproject.view.GetPushListView;
import com.uou.capstoneproject.view.GetSimpleInfoView;
import com.uou.capstoneproject.view.GetUserInfoView;
